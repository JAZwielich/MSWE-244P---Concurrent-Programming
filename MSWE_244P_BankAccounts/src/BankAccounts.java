 ...
 * @author Crista Lopes
 */
//Look at the transfer money section below
    ...
    public static void transferMoney(Account fromAccount,
            ...
            throws InsufficientFundsException {
                if (fromAccount.getBalance().compareTo(amount) < 0)
					...
					//Originally these two synchronizations were overlapping. Be seperating them it makes the code more efficient.
					//Other threads can use the resources concurrently and now that it's not nested it frees up the resources
